...
remain under human control (Fig.~\ref{fig:architecture}). Decomposing the
...
the next, whose flow is shown in Fig.~\ref{fig:dataflow};
Table~\ref{tab:stack} lists the technology stack.
...
(Table~\ref{tab:failures}). The largest pricing errors came from multipacks and
