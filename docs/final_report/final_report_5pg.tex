...
Figure~\ref{fig:processflow_appendix} shows the high-level process flow
across the six pipeline stages, and Figure~\ref{fig:architecture_appendix}
presents the complete Snap-to-Sell architecture, including the inputs and
outputs exchanged at each stage.

\begin{figure}[h]
\centering
\centerline{\includegraphics[height=7in]{architecture.pdf}}
